...
int main(int argc, char **argv) {
    ...
    gfx::RenderPipelineDesc gbuffer_pipeline_desc {
        ...
        .primitive_state = gfx::PrimitiveState {
            .cull_mode = gfx::CullMode::eBackFace,
        },
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        rg.AddRenderPass("gbuffer",
            [&](gfx::RenderPassBuilder &builder) {
                builder
                    .Color(0, gfx::RenderPassColorTargetBuilder(gbuffer_pos).ClearColor())
                    .Color(1, gfx::RenderPassColorTargetBuilder(gbuffer_normal).ClearColor())
                    .Color(2, gfx::RenderPassColorTargetBuilder(gbuffer_color).ClearColor())
                    .DepthStencil(gfx::RenderPassDepthStencilTargetBuilder(gbuffer_depth).ClearDepthStencil());
            },
        ...
        rg.AddRenderPass("lighting",
            [&](gfx::RenderPassBuilder &builder) {
                builder
                    .Color(0, gfx::RenderPassColorTargetBuilder(back_buffer).ClearColor())
