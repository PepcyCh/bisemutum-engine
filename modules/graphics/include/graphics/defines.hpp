...
inline bool IsSrgbFormat(ResourceFormat format) {
    return format == ResourceFormat::eR8Srgb
        || format == ResourceFormat::eRg8Srgb
        || format == ResourceFormat::eRgb8Srgb
        || format == ResourceFormat::eBgr8Srgb
        || format == ResourceFormat::eRgba8Srgb
        || format == ResourceFormat::eBgra8Srgb
        || format == ResourceFormat::eAbgr8Srgb
        || format == ResourceFormat::eBc1RgbSrgb
        || format == ResourceFormat::eBc1RgbaSrgb
        || format == ResourceFormat::eBc2Srgb
        || format == ResourceFormat::eBc3Srgb
        || format == ResourceFormat::eBc7Srgb;
}
