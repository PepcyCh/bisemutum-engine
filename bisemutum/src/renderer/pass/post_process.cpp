...
PostProcessPass::PostProcessPass() {
    ...
    bloom_pre_shader_.source.path = "/bisemutum/shaders/renderer/post_process/bloom_pre.hlsl";
    ...
    bloom_filter_shader_[0].source.path = "/bisemutum/shaders/renderer/post_process/bloom_filter.hlsl";
    ...
    bloom_filter_shader_[1].source.path = "/bisemutum/shaders/renderer/post_process/bloom_filter.hlsl";
    ...
    bloom_combine_shader_.source.path = "/bisemutum/shaders/renderer/post_process/bloom_combine.hlsl";
    ...
    fragment_shader_.source.path = "/bisemutum/shaders/renderer/post_process/post_process.hlsl";
