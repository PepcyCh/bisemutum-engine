...
SkyboxPass::SkyboxPass() {
    fragment_shader_params.initialize<SkyboxPassParams>();

    fragment_shader.source_path = "/bisemutum/shaders/renderer/skybox_pass.hlsl";
    fragment_shader.source_entry = "skybox_pass_fs";
    fragment_shader.set_shader_params_struct<SkyboxPassParams>();
    fragment_shader.depth_write = false;
    fragment_shader.depth_compare_op = rhi::CompareOp::less_equal;
}
...
auto SkyboxPass::update_params(SkyboxContext& skybox_ctx) -> void {
    ...
    auto params = fragment_shader_params.mutable_typed_data<SkyboxPassParams>();
